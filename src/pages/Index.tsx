...
// Imports and types for the contact form
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Contact Section from Contact.tsx */}
      <section id="contact-section" className="pt-20 pb-16 min-h-screen flex items-center bg-black text-white">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <Button 
                    ...
                    className="bg-emerald-600 text-white hover:bg-emerald-700 font-semibold px-8 py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
                  >
